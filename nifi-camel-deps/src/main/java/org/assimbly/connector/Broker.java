...
public interface Broker {
  ...
  // configure broker
  /**
   * Get the broker configuration as XML from the broker path. A default configuration is return
  ...
  /**
   * Sets the broker configuration from a XML A default configuration is return when
   * brokerConfiguration param is an empty string.
   *
  ...
  /**
   * Get the broker (can be used to access extended methods by the implementation (ActiveMQ classic,
   * ActiveMQ artemis) Note: You need to cast the object based on the implementation you are
   * calling. And...calling this you're on your own :)
   *
