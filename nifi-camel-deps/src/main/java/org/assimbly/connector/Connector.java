...
public interface Connector {
  ...
  // configure connector
  /**
   * Sets the connector configuration from a list of flow configurations (TreeMap&lt;
   * Key,Value&gt;). The configuration cleared after a connector is reinitialized.
   *
  ...
  /**
   * Sets the connector configuration from a string of a specific format (XML,JSON,YAML). The
   * configuration cleared after a connector is reinitialized.
   *
  ...
  // configure flow
  /**
   * Sets the flow configuration from a Tree (keyvalues). This list is cleared after a connector is
   * reinitialized.
   *
  ...
  /**
   * Sets the flow configuration from a string for a specific format (XML,JSON,YAML). This list is
   * cleared after a connector is reinitialized.
   *
  ...
  // manage connector
  /**
   * Starts a connector. The connector acts like a container for flows. After starting it can be
   * configured
   *
   ...
   *
   * <p>Download the chain of certificates for the specified url
   *
   ...
   *
   * <p>Download and import certificates to truststore (jks) used by the connector
   *
   * @param url an https url
   ...
   *
   * <p>Import certificate into truststore (jks) used by the connector
   *
   * @param certificateName name of the certificate
   ...
   *
   * <p>Import certificates to truststore (jks) used by the connector
   *
  ...
  /**
   * Resolve the Camel component dependency by scheme name (this is download and dynamically loaded
   * in runtime)
   *
  ...
  /**
   * Get the context of connector (can be used to access extended methods by the implementation
   * (Camel) Note: Calling this you're on your own :)
   *
