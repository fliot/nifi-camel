...
public class JSONFileConfiguration {
  ...
  public String createConfiguration(String connectorId, List<TreeMap<String, String>> properties)
      throws Exception {
  ...
  public List<TreeMap<String, String>> getConfiguration(
      String connectorId, String jsonConfiguration) throws Exception {
  ...
  public TreeMap<String, String> getFlowConfiguration(String flowId, String jsonConfiguration)
      throws Exception {
