...
public abstract class BaseConnector implements Connector {
  ...
  private static Logger logger =
      LoggerFactory.getLogger("org.assimbly.connector.impl.BaseConnector");
  ...
  public void setConfiguration(String connectorId, String mediaType, String configuration)
      throws Exception {
  ...
  public void removeFlowConfigurationIfExist(TreeMap<String, String> configuration)
    ...
    while (i.hasNext()) {
      TreeMap<String, String> currentConfiguration =
  ...
  public void setFlowConfiguration(String flowId, String mediaType, String configuration)
      throws Exception {
  ...
  // --> convert methods (XML)
  public String convertConfigurationToXML(
      String connectorid, List<TreeMap<String, String>> configuration) throws Exception {
    return new XMLFileConfiguration().createConfiguration(connectorid, configuration);
  }

  public List<TreeMap<String, String>> convertXMLToConfiguration(
      String connectorid, String configuration) throws Exception {
    return new XMLFileConfiguration().getConfiguration(connectorid, configuration);
  }

  public List<TreeMap<String, String>> convertXMLToConfiguration(
      String connectorid, URI configurationUri) throws Exception {
    return new XMLFileConfiguration().getConfiguration(connectorid, configurationUri);
  }

  public TreeMap<String, String> convertXMLToFlowConfiguration(
      String connectorId, String configuration) throws Exception {
    return new XMLFileConfiguration().getFlowConfiguration(connectorId, configuration);
  }

  public TreeMap<String, String> convertXMLToFlowConfiguration(String flowId, URI configurationUri)
      throws Exception {
    return new XMLFileConfiguration().getFlowConfiguration(flowId, configurationUri);
  }

  public String convertFlowConfigurationToXML(TreeMap<String, String> configuration)
      throws Exception {
    return new XMLFileConfiguration().createFlowConfiguration(configuration);
  }

  // --> convert methods (JSON)
  public String convertConfigurationToJSON(
      String connectorid, List<TreeMap<String, String>> configuration) throws Exception {
    return new JSONFileConfiguration().createConfiguration(connectorid, configuration);
  }

  public List<TreeMap<String, String>> convertJSONToConfiguration(
      String connectorid, String configuration) throws Exception {
    return new JSONFileConfiguration().getConfiguration(connectorid, configuration);
  }

  public TreeMap<String, String> convertJSONToFlowConfiguration(String flowId, String configuration)
      throws Exception {
    return new JSONFileConfiguration().getFlowConfiguration(flowId, configuration);
  }

  public String convertFlowConfigurationToJSON(TreeMap<String, String> configuration)
      throws Exception {
  ...
  public String convertConfigurationToYAML(
      String connectorid, List<TreeMap<String, String>> configuration) throws Exception {
    return new YAMLFileConfiguration().createConfiguration(connectorid, configuration);
  }

  public List<TreeMap<String, String>> convertYAMLToConfiguration(
      String connectorid, String configuration) throws Exception {
    return new YAMLFileConfiguration().getConfiguration(connectorid, configuration);
  }

  public TreeMap<String, String> convertYAMLToFlowConfiguration(String flowId, String configuration)
      throws Exception {
    return new YAMLFileConfiguration().getFlowConfiguration(flowId, configuration);
  }

  public String convertFlowConfigurationToYAML(TreeMap<String, String> configuration)
      throws Exception {
  ...
  // --> abstract methods (needs to be implemented in the subclass specific to the integration
  // framework)
  ...
  public abstract String getComponentSchema(String componentType, String mediaType)
      throws Exception;

  public abstract String getComponentParameters(String componentType, String mediaType)
      throws Exception;
  ...
  public abstract Map<String, Certificate> importCertificatesInTruststore(
  ...
  public abstract void sendWithHeaders(
      Object messageBody, TreeMap<String, Object> messageHeaders, ProducerTemplate template);
}
