...
public class CamelConnector extends BaseConnector {
  ...
  private static Logger logger =
      LoggerFactory.getLogger("org.assimbly.camelconnector.connect.impl.CamelConnector");
  ...
  public void setBasicSettings() throws Exception {
    ...
    // set basic settings
    org.apache.camel.support.SimpleRegistry registry =
        new org.apache.camel.support.SimpleRegistry();
    ...
    ((SSLContextParametersAware) context.getComponent("ftps"))
        .setUseGlobalSslContextParameters(true);
    ((SSLContextParametersAware) context.getComponent("https"))
        .setUseGlobalSslContextParameters(true);
    ((SSLContextParametersAware) context.getComponent("imaps"))
        .setUseGlobalSslContextParameters(true);
    ((SSLContextParametersAware) context.getComponent("kafka"))
        .setUseGlobalSslContextParameters(true);
    ((SSLContextParametersAware) context.getComponent("netty"))
        .setUseGlobalSslContextParameters(true);
    ((SSLContextParametersAware) context.getComponent("smtps"))
        .setUseGlobalSslContextParameters(true);
  ...
  public String getStats(String statsType, String mediaType) throws Exception {
    ...
    if (statsType.equals("history")) {
      ...
      MetricsMessageHistoryService historyService =
  ...
  public String getComponentParameters(String componentType, String mediaType) throws Exception {
    ...
    String parameters =
        managed.getManagedCamelContext().componentParameterJsonSchema(componentType);
