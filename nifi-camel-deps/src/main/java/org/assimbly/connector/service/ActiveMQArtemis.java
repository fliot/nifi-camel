...
public class ActiveMQArtemis implements Broker {
  ...
  private static Logger logger =
      LoggerFactory.getLogger("org.assimbly.connector.service.BrokerArtemis");
  ...
  public String start() throws Exception {
    ...
    if (brokerFile.exists()) {
      ...
      logger.info(
          "broker.xml documentation reference:"
      ...
      logger.info(
          "Created default 'broker.xml' stored in following directory: " + baseDir + "/broker");
      logger.info(
          "broker.xml documentation reference:"
              + " https://activemq.apache.org/components/artemis/documentation/latest/configuration-index.html");
      logger.info("");
  ...
  public String stop() throws Exception {
    ...
    if (activeBroker != null) {
      ...
      logger.info(
          "Broker with nodeId '" + nodeID + "' is stopping. Uptime=" + activeBroker.getUptime());
      broker.stop();
  ...
  public String info() throws Exception {
    ...
    if (status().equals("started")) {
      ...
      String info =
          "uptime="
              + activeBroker.getUptime()
              + ",totalConnections="
              + activeBroker.getTotalConnectionCount()
              + ",totalConsumers="
              + activeBroker.getTotalConsumerCount()
              + ",totalMessages="
              + activeBroker.getTotalMessageCount()
              + ",nodeId="
              + activeBroker.getNodeID()
              + ",state="
              + activeBroker.getState()
              + ",version="
              + activeBroker.getVersion().getFullVersion()
