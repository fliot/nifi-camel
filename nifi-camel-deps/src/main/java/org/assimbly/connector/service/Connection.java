...
public class Connection {
  ...
  private static Logger logger =
      LoggerFactory.getLogger("org.assimbly.connector.service.Connection");
    ...
    if (uri != null) {
      ...
      if (connectionId != null) {
        ...
        switch (i) {
          ...
          default:
            logger.error(
                "Connection parameters for component " + component + " are not implemented");
            throw new Exception(
                "Connection parameters for component " + component + " are not implemented");
        }
      }
  ...
  private void setupActiveMQConnection(
      TreeMap<String, String> properties, String direction, String componentName) throws Exception {
    ...
    String concurentConsumers =
        properties.get("service." + serviceId + "service.concurentConsumers");
      ...
      if (url != null) {
        ...
        if (conType.equals("basic")) {
          ...
          context.addComponent(
              componentName, JmsComponent.jmsComponentAutoAcknowledge(activeMQConnectionFactory));
  ...
  private void setupSJMSConnection(TreeMap<String, String> properties, String direction)
      throws Exception {
  ...
  // private void setupSonicMQConnection(TreeMap<String, String> properties, String direction,
  ...
  // connection.setConnectID("Assimbly/Gateway/" + connectionId + "/Flow/" + flowId + "/" +
  // connectId);
  ...
  // jms.setConnectionClientId("Assimbly/Gateway/" + connectionId + "/Flow/"  + flowId + "/" +
  // connectId);
  ...
  // @SuppressWarnings("unused")
  // private void removeSonicMQConnection(TreeMap<String, String> properties, String direction,
  // String connectId) throws Exception{
  ...
  private void setupJDBCConnection(TreeMap<String, String> properties, String direction)
      throws Exception {
